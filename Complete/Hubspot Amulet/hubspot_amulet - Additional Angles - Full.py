...
def checkio(matrix):
    ...
    additional_angles = [360 * i for i in range(-10, 10)]
    ...
    all_angles = []
    for additional_angles_permutation in additional_angles_permutations:
